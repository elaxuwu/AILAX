...
I make this for fun
Please don't use it **yet** if you don't understand codes.
Instruction coming soon! Whenever I feels like it...
...
- Added mode switching function, you can now say "switch mode 'mode'" to switch between avaiable modes! (Currently available mode: General mode & Coding mode)
